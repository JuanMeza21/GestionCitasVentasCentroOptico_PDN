...
import { getAuth, GithubAuthProvider, GoogleAuthProvider, signInWithPopup, FacebookAuthProvider} from "firebase/auth";
...
export {auth,db,githubProvider,googleProvider,signInWithPopup,facebookProvider};